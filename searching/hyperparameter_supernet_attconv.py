...
'''
# experiment 3 - replace the first conv layer with attention
block1_ckpt = '/home/hang/projects/def-wjgross/hang/bert_nas/checkpoint_block/block_1/time=25/06/2021 09:46:18/epoch=150-val_loss=0.12.ckpt'
block2_ckpt = '/home/hang/projects/def-wjgross/hang/bert_nas/checkpoint_block/block_2/time=25/06/2021 10:15:21/epoch=155-val_loss=0.10.ckpt'
block3_ckpt = '/home/hang/projects/def-wjgross/hang/bert_nas/checkpoint_block/block_3/time=25/06/2021 10:39:37/epoch=158-val_loss=0.19.ckpt'
block4_ckpt = '/home/hang/projects/def-wjgross/hang/bert_nas/checkpoint_block/block_4/time=25/06/2021 11:33:45/epoch=157-val_loss=0.23.ckpt'
block5_ckpt = '/home/hang/projects/def-wjgross/hang/bert_nas/checkpoint_block/block_5/time=25/06/2021 11:40:41/epoch=154-val_loss=0.15.ckpt'
block6_ckpt = '/home/hang/projects/def-wjgross/hang/bert_nas/checkpoint_block/block_6/time=25/06/2021 12:16:24/epoch=119-val_loss=0.06.ckpt'
'''
...
def train_hyper_search(config, num_epochs=10, num_gpus=1):
    ...
    # trainer = Trainer(callbacks=[checkpoint_callback, early_stop_callback, hyper_finetune_callback], gpus=-1, num_nodes=1, max_epochs=num_epochs, progress_bar_refresh_rate=30, logger=wandb_logger)
